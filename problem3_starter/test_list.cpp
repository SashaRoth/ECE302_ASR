...
TEST_CASE("Lists: Test ArrayList destructor", "[ArrayList]"){
  ArrayList<int> a;
}
...
TEST_CASE("Lists: Test ArrayList insert method", "[ArrayList]"){
  ArrayList<int> a;
}

TEST_CASE("Lists: Test ArrayList remove method", "[ArrayList]"){
  ArrayList<int> a;
}

TEST_CASE("Lists: Test ArrayList method", "[ArrayList]"){
  ArrayList<int> a;
}
...
TEST_CASE("Lists: Test ArrayList getEntry method", "[ArrayList]"){
  ArrayList<int> a;
}

TEST_CASE("Lists: Test ArrayList setEntry method", "[ArrayList]"){
  ArrayList<int> a;
}
...
TEST_CASE("Lists: Test LinkedList destructor", "[LinkedList]"){
  LinkedList<int> l;
}
...
TEST_CASE("Lists: Test LinkedList insert method", "[LinkedList]"){
  LinkedList<int> l;
}

TEST_CASE("Lists: Test LinkedList remove method", "[LinkedList]"){
  LinkedList<int> l;
}

TEST_CASE("Lists: Test LinkedList method", "[LinkedList]"){
  LinkedList<int> l;
}
...
TEST_CASE("Lists: Test LinkedList getEntry method", "[LinkedList]"){
  LinkedList<int> l;
}

TEST_CASE("Lists: Test LinkedList setEntry method", "[LinkedList]"){
  LinkedList<int> l;
}
